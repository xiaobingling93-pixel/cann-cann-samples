...
QBMM_MX_KERNEL_CLASS_TEM_PARAMS
__aicore__ inline void QuantMatmulMxKernelLastRoundTileBalanceImpl<QBMM_MX_KERNEL_FUN_TEM_PARAMS>::ResetGmAddr(
    const Params& params)
{
...
__global__ __aicore__ __cube__ void QuantMatmulMxfp4LastRoundTileBalanceKernel(uint64_t m, uint64_t k, uint64_t n,
