...
#ifndef QUANT_MATMUL_MXFP4_BLOCK_MMAD_SWAT_H
#define QUANT_MATMUL_MXFP4_BLOCK_MMAD_SWAT_H
...
public:
    ...
    __aicore__ inline BlockMmadMxSwat()
    {
        #pragma unroll
        ...
        const TupleShape& problemShape, const BlockShape& l0TileShape, const L1Params& l1Params)
    {
        ...
        scaleAL1OneBuffer_ = baseM_ * CeilDiv(kL1_, MXFP_DIVISOR_SIZE_LOCAL) * MXFP_MULTI_BASE_SIZE_LOCAL;
        ...
        for (uint64_t iter0 = 0; iter0 < kL1Iter_; ++iter0) {
            ...
            AscendC::WaitFlag<AscendC::HardEvent::MTE1_MTE2>(SCALE_BUFFER_FLAG_0 + scaleL1BufId);
            {
                ...
                auto layoutScaleAL1 = AscendC::Te::MakeZzLayout<fp8_e8m0_t>(
                    curM, CeilDiv(kL1_, MXFP_GROUP_SIZE_LOCAL));
